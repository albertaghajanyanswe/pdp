...
bool List::pushFront(const int key, const int value) {
...
bool List::getValueByKey(int key, int& value) {
    if (nullptr == head) {
...
bool List::getKeyByValue(int& key, int value) {
    if (nullptr == head) {
        return false;
    }
    if (head -> value == value) {
...
bool List::findKey(int& key, int& value) {
    if (head == NULL) {
        return false;
    }
    if (head -> key == key) {
...
bool List::deleteByKey(const int & delKey, int & value) {
    if (nullptr == head) {
        return false;
    }
    if (head -> key == delKey) {
